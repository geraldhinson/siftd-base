...
const (
	...
	HTTPS_CERT_FILENAME       = "HTTPS_CERT_FILENAME"
	HTTPS_KEY_FILENAME        = "HTTPS_KEY_FILENAME"
	CALLED_SERVICES           = "CALLED_SERVICES"
	NOUN_DB_POOL_MAX_CONNS    = "NOUN_DB_POOL_MAX_CONNS"
	JOURNAL_DB_POOL_MAX_CONNS = "JOURNAL_DB_POOL_MAX_CONNS"
	HEALTH_DB_POOL_MAX_CONNS  = "HEALTH_DB_POOL_MAX_CONNS"
	JOURNAL_MAX_BATCH_SIZE    = "JOURNAL_MAX_BATCH_SIZE"
)
...
const (
	...
	RESOURCE_UNAUTHORIZED_CODE     = -403    // Change not authorized (note similarity to HTTP status codes)
